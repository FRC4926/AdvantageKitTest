...
public class TunerConstants {
  ...
  public static final double steerCurrent = 40;
  ...
  // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput //10       //5.5
  private static final Slot0Configs driveGains =
      new Slot0Configs() // .withKP(1).withKS(0);
          .withKP(1)
          .withKI(0)
          .withKD(0)
          .withKS(0)
